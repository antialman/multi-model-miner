...
import data.v4.ActivitySelector;
...
public class ConstraintsTabController {
	...
	private void initialize() {
		WebViewUtilsV4.setupWebView(declMinerWebView);
	...
	private void updateVisualization() { //Automatic update would be possible, but requires special care because execution of the visualization script is asynchronous
		...
		WebViewUtilsV4.updateWebView(filteredActivities, filteredConstraints, declMinerWebView, altLayoutCheckBox.isSelected(), automatonCheckBox.isSelected(), activityToEncodingsMap);
